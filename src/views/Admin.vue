                ...
                <div class="flex w-full pt-2 content-center justify-between md:w-1/3 md:justify-end">
                    <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                        <li class="flex-1 md:flex-none md:mr-3">
                            <router-link :to="{name: 'bots'}" class="inline-block py-2 px-4 text-white no-underline" href="#">Bots</router-link>
                        </li>
                        <li class="flex-1 md:flex-none md:mr-3">
                            <router-link :to="{name: 'users'}" class="inline-block text-gray-400 no-underline hover:text-gray-200 hover:text-underline py-2 px-4"
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                        ...
                        <div
                            ...
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-pink-600"> <i class="fa-2x fa-inverse w-sm"><font-awesome-icon :icon="['fas', 'user']" /></i>
                                    </div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Total Users</h2>
                                    <p class="font-bold text-3xl"> {{ users.length }} <span class="text-pink-500"><i
